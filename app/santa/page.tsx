    ...
    <div className="mx-20 flex flex-row justify-center">
      <div className="w-2/6 mt-60">
        <div className="flex flex-row space-x-3">
          <div className="bg-yellow-500 rounded-lg p-2 text-center text-black text-xl border-2 border-black">New!</div>
          <div className="bg-green-500 rounded-lg p-2 text-center text-black text-xl border-2 border-black">Exciting!</div>
          <div className="bg-red-300 rounded-lg p-2 text-center text-black text-xl border-2 border-black">Santa!</div>
        </div>
        <br />
