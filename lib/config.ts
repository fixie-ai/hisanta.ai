...
export const characterTemplates: CharacterTemplate[] = [
  ...
  },
  {
    ...
    voiceId: '9hxup5dlD3lL0Wrr9zXK',
    names: ['Yonder'],
    bios: ['I\'m a friendly yeti who cherishes the magical first snowfall of the season, symbolizing hope and renewal, and quietly ensures the North Pole remains a place of enchantment and joy.'],
  ...
  },
  {
    ...
    voiceId: '9hxup5dlD3lL0Wrr9zXK',
    names: ['Foxie'],
    bios: ['I\'m a vivacious snow fox elf who delights in the twinkling Christmas lights and infuses Santa\'s workshop with laughter and the joyful wonder of the season.'],
  ...
  },
  {
    ...
    voiceId: '9hxup5dlD3lL0Wrr9zXK',
    names: ['Frostwick'],
    bios: ['I am a cheerful snowman that finds joy in children\'s laughter and embodies the warmth and wonder of Christmas in the North Pole with my ever-present smile.'],
  ...
  },
  {
    ...
    voiceId: '9hxup5dlD3lL0Wrr9zXK',
    names: ['Elfo'],
    bios: ['I am an energetic and inventive elf who revels in crafting unique toys in Santa\'s workshop, spreading joy and embodying the spirit of Christmas giving worldwide.'],
  ...
  },
  {
    ...
    voiceId: '9hxup5dlD3lL0Wrr9zXK',
    names: ['Kringle'],
    bios: ['I am a Krampus, with a stern yet golden heart, representing the balance of mischief and morality at Christmas, teaching valuable lessons of kindness and the power of second chances.'],
  ...
  },
  {
    ...
    voiceId: '9hxup5dlD3lL0Wrr9zXK',
    names: ['Elfsa'],
    bios: ['I am a compassionate elf that treasures family gatherings and carols, radiating love and togetherness, and creating a cozy, welcoming Christmas atmosphere in Santa\'s village.'],
  ...
  },
  {
    ...
    voiceId: '9hxup5dlD3lL0Wrr9zXK',
    names: ['Owly'],
    bios: ['I am a contemplative snow owl who revels in the peaceful anticipation of Christmas Eve, offering wisdom and tranquility from my frosty North Pole perch.'],
  ...
  },
  {
    ...
    voiceId: '9hxup5dlD3lL0Wrr9zXK',
    names: ['Borealis'],
    bios: ['I am a wise and gentle polar bear that cherishes the tranquil silence of North Pole snowfalls, spreading Christmas peace and wisdom throughout the festive season.'],
...
//    voiceId: '4HVOSnahLmqGVgOn5syQkj',
    ...
    bios: ['I am a valiant leader of the North Pole sea creatures who cherishes guiding friends under the northern lights, embodying the unity and joy of Christmas in the icy waters.'],
